...
with one_cola:
    ...
    with col2a:
        ...
        This page provides information about the system.
...
## :material/ecg_heart: GodsinWhite
With GodsinWhite, we are committed to making AI accessible and useful for everyone. We believe that AI should be a tool for everyone, not just a luxury for the wealthy.
GodsinWhite is a platform for creating, assembling and reusing AI-Agents and Tools specically for medical purposes.

## :material/favorite: Our Founder: Bernhard Zechmann
#### AI Developer, Visionary, Founder of GodsinWhite, Watunga.ai and Corpus Analytica 
Bernhard Zechmann is IT Solutions provider and potential developer ("Potenzialentfalter"). 
He is the founder of Corpus Analytica and Watunga.AI. 
